...
{
    static String path="D:\\FaceTemp.dat";

    static String Location="./images/";

    static String OwnerEmail="dhruvpawar121@gmail.com";
	...
	try
		...
		jpInfo.setLayout (null);
		  ...
		  jprgbar = new JProgressBar();
  		  ...
  		  jprgbar.setString(" Recognizer System ");
		...
		l2 = new JLabel ("Ashish Garad");
		l2.setForeground (Color.black);
		l2.setBounds (340, 80, 190, 25);

		l3 = new JLabel ("Dhruv Pawar");
		l3.setForeground (Color.black);
		l3.setBounds (340, 100, 190, 25);

		l4 = new JLabel ("Shweta Shivsaran");
		l4.setForeground (Color.black);
		l4.setBounds (340, 120, 190, 25);

		l5 = new JLabel ("Soham Sawant");
		l5.setForeground (Color.black);
		l5.setBounds (340, 140, 190, 25);

		l6 = new JLabel ("*** Guided By ***");
		l6.setForeground (Color.red);
		l6.setBounds (320, 160, 190, 25);

		l7 = new JLabel ("Prof.Latika Desai");
		l7.setForeground (Color.black);
		l7.setBounds (340, 180, 190, 25);
